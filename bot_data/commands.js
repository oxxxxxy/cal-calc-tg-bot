...
const settings = {
	...
	,setTime:{
		...
		,parameterDescription:`Необходимо задать для подсчета съеденного. По умолчанию задано время по МСК (UTC+3). На примере ниже 28 текущего месяца 13 часов 37 минут.`
		,usageExamples:[
			`зв  28:13:37`
		]
	}
